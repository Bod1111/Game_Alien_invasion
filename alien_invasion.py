...
class AlienInvasuon:
    ...
    def _check_play_button(self, mouse_pos):
        """Запускает новвую игру при нажатии на кнопку Play."""
    ...
    def _check_bullet_alien_collision(self):
        """Проверка колизий снарядов с пришельцами."""
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0 :
            # Уменьшение ship_left и обновляет панель счета
    ...
    def _create_fleet(self):
        ...
        # Интервал между соседним пришельцем равен ширине пришельца.
        alien = Alien(self)
        ...
        available_space_y = (self.settings.screen_hieght - (3 * alien_height) - 
                                ship_height)
    ...
    def _check_fleet_edges(self):
        """Реагирует на достижение пришельцем края экрана спрва или слева."""
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                # роисходит то же что при столкновении с кораблем
                self._ship_hit()
                break
    ...
    def _update_screen(self):
        ...
        # При каждом проходе цикла перерисовываетс экран
        ...
        # Отображене последнего прорисованного экрана.
        pygame.display.flip()
